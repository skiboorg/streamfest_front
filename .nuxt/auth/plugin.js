...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/","method":"post","propertyName":"auth_token"},"logout":{"url":"/","method":"post"},"user":{"url":"/","method":"get","propertyName":false}},"tokenType":"Token","_name":"local"}))
